...
define('DB_NAME', 'th3loniu_fancypants');

/** MySQL database username */
define('DB_USER', 'th3loniu_fancy');

/** MySQL database password */
define('DB_PASSWORD', 'fancypants');
...
define('WP_HOME', 'http://matthewmesaros.com/fancypants');
define('WP_SITEURL', 'http://matthewmesaros.com/fancypants');
